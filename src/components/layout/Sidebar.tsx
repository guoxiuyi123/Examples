...
import { BookOpen, Compass, LayoutDashboard, MessageSquare, Trophy, User } from "lucide-react";
...
const navItems = [
  ...
  { path: "/courses", label: "课程大厅", icon: Compass },
  { path: "/study", label: "我的学习", icon: BookOpen },
