...
import { Play, Flame, Target, Trophy, Clock, ArrowRight, User } from 'lucide-react';
    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <motion.div 
          ...
          className="space-y-1"
        >
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-white">欢迎回来，Alex 👋</h1>
          <p className="text-muted-foreground text-sm md:text-base">你已经连续学习 <span className="text-accent font-bold">12</span> 天了，继续保持！</p>
        </motion.div>
